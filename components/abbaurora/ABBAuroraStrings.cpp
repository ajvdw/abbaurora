...
std::string ABBAuroraStrings::InverterState(uint8_t id)
{
    switch (id)
    {
        ...
        default: return std::string("Unknown:") + id;
    }
}
...
std::string ABBAuroraStrings::VersionPart1(uint8_t id)
{
    switch ((char)id)
    {
        case 'i': return std::string("Aurora 2 kW indoor");
        case 'o': return std::string("Aurora 2 kW outdoor");
        case 'r': return std::string("ABB TRIO 5.8kW outdoor");
        case 'I': return std::string("Aurora 3.6 kW indoor");
        case 'O': return std::string("Aurora 3.0 - 3.6 kW outdoor");
        case '5': return std::string("Aurora 5.0 kW outdoor");
        case '6': return std::string("Aurora 6 kW outdoor");
        case 'P': return std::string("3 - phase interface (3G74)");
        case 'C': return std::string("Aurora 50kW module");
        case '4': return std::string("Aurora 4.2kW new");
        case '3': return std::string("Aurora 3.6kW new");
        case '2': return std::string("Aurora 3.3kW new");
        case '1': return std::string("Aurora 3.0kW new");
        case 'D': return std::string("Aurora 12.0kW");
        case 'X': return std::string("Aurora 10.0kW");
        default: return std::string("Unknown");
    }
}
...
std::string ABBAuroraStrings::VersionPart2(uint8_t id)
{
    switch ((char)id)
    {
        case 'A': return std::string("UL1741");
        case 'E': return std::string("VDE0126");
        case 'S': return std::string("DR 1663 / 2000");
        case 'I': return std::string("ENEL DK 5950");
        case 'U': return std::string("UK G83");
        case 'K': return std::string("AS 4777");
        default: return std::string("Unknown");
    }
}
...
std::string ABBAuroraStrings::VersionPart3(uint8_t id)
{
    switch ((char)id)
    {
        case 'N': return std::string("Transformerless Version");
        case 'T': return std::string("Transformer Version");
        default: return std::string("Unknown");
    }
}
...
std::string ABBAuroraStrings::VersionPart4(uint8_t id)
{
    switch ((char)id)
    {
        case 'W': return std::string("Wind version");
        case 'N': return std::string("PV version");
        default: return std::string("Unknown");
    }
}
